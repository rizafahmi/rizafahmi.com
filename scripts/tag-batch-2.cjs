...
const plan = {
  "src/catatan/5-kebiasaan-coding-yang-menjadikan-kamu-super-developer.md": [
    "catatan",
    "produktivitas",
    "belajar",
    "developer",
  ...
  "src/catatan/bahasa-fungsional-elixir.md": [
    "catatan",
    "elixir",
  ...
  "src/catatan/machine-learning-for-web-developers.md": [
    "catatan",
    "machine-learning",
    "web",
    "javascript",
  ...
  "src/catatan/prototipe-dengan-phoenix.md": [
    "catatan",
    "elixir",
    "phoenix",
    "tutorial",
...
function ensureTagsList(fm, tags) {
  ...
  fm = fm.replace(/\ntags:\s*([^\n]+)\n/, (_m, scalar) => {
    ...
    if (existing && existing !== "[]")
      merged.add(normalizeTag(existing.replace(/^['"]|['"]$/g, "")));
    return `\ntags:\n${[...merged].map((t) => `  - ${t}`).join("\n")}\n`;
  });
