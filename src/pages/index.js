        ...
        <div className="flex mb-4">
          ...
          <div className="w-3/5 align-top">
            ...
            <p className="leading-loose py-3">
              ...
              . So if you are nearby Jakarta, please do come or become our
              speaker at the meetup.
            </p>
            <p className="leading-loose py-3">
              ...
              technology person from Indonesia. To motivate, inspire and
              encourage young developers to become a great one.
            </p>
            <p className="leading-loose py-3">
            ...
            <div className="leading-loose py-3">
              ...
              <ul>
                ...
                <li>
                  ...
                  -- This screencast episode explains how to setup your VIM
                  editor from scratch.
                </li>
              </ul>
            </div>
