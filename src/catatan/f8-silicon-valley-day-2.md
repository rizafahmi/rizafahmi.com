...
{% image "./assets/images/f82/1_kGLsZ2WXzljMjkMhh2fIBQ.jpeg", "Talk by CTO Facebook Mike Schroepfer" %}_Talk by CTO Facebook Mike Schroepfer_
...
{% image "./assets/images/f82/1_pjoseGiSS_VOq1dt3CrP2g.jpeg", "Install Haskell Stack gagal" %}_Install Haskell Stack gagal_
...
{% image "./assets/images/f82/1_zLCDavSW83EPIT-lAietKA.jpeg", "ReactNative Discussion Panel" %}_ReactNative Discussion Panel_
...
{% image "./assets/images/f82/1_uydj0iEZdDV4YwlIJROfjA.jpeg", "With Gina Trapani" %}_With Gina Trapani_
...
{% image "./assets/images/f82/1_uBrvNLqvOB-MVKznzTcRXw.jpeg", "Sesi ReactNative dan ReactVR" %}_Sesi ReactNative dan ReactVR_
...
{% image "./assets/images/f82/1_qQi_vvtayQxkE3-ssIAl2Q.jpeg", "Nila on the slide" %}_Nila on the slide_
...
{% image "./assets/images/f82/1_HDGD81BS3J24_PgSn8gefQ.jpeg", "Maaf, saya kurang bisa wefie." %}_Maaf, saya kurang bisa wefie._

{% image "./assets/images/f82/1_Dvj3KZGNDswBIHZrlmpSUA.jpeg", "With Leads, mother of Leads (Elisha) and Mother of mother of Leads (Alice)." %}_With Leads, mother of Leads (Elisha) and Mother of mother of Leads (Alice)._
...
{% image "./assets/images/f82/1_ScFO7DsZZOrqvJVsHJ_4qg.jpeg", "With Farid" %}_With Farid_
