...
{% image "./assets/images/cds/1__qVaoo5NzVm8UgujxqQfUg.png", "Yohan Totting — Developer Advocate, Web Developer Relations at Google" %}_Yohan Totting — Developer Advocate, Web Developer Relations at Google_
...
{% image "./assets/images/cds/1_KGqjtipczDlZErawutzSSQ.png", "Warat Wongmaneekit (kanan)" %}_Warat Wongmaneekit (kanan)._
...
{% image "./assets/images/cds/1_qgBvAulWYDj_vsgONAMHYw.png", "Jeff Posnick — Developer Platform Engineer at Google" %}_Jeff Posnick — Developer Platform Engineer at Google_
...
{% image "./assets/images/cds/1_kq0fNkin8vBfmenP7PDMlg.png", "Berada satu lingkaran dengan para experts" %}_Berada satu lingkaran dengan para experts._
...
{% image "./assets/images/cds/1_BXXlQnFRaDaDDhW3q9lRoQ.jpeg", "Bersama sang Legenda, Ariya Hidayat" %}_Bersama sang Legenda, Ariya Hidayat_
...
{% image "./assets/images/cds/1_UQAwr3lgW6hg7GzcRf2E8g.png", "Paul Irish — Performance Engineer at Google" %}**Paul Irish — Performance Engineer at Google**
...
{% image "./assets/images/cds/1_2w2llYk5fok7ylcU5zaUBQ.png", "Pete LePage — Dev Advocate at google" %}*Pete LePage — *Dev Advocate at google\*\*
...
{% image "./assets/images/cds/1_8dKYVqXD9qpBVHiI91e2mg.png", "Akhirnya bisa bertemu Pak Jeff secara langsung" %}_Akhirnya bisa bertemu Pak Jeff secara langsung_
...
{% image "./assets/images/cds/1_-PLXV7dY7mr189OsfH2cZQ.png", "Jason Waterman — Co-founder, CTO Momentum" %}**Jason Waterman — Co-founder, CTO Momentum**
...
{% image "./assets/images/cds/1_hAn3urFSLoRJGLGRGk6L3A.png", "Alex Russell — Senior Engineer at Google" %}_Alex Russell — Senior Engineer at Google_
...
{% image "./assets/images/cds/1_Sa4zAFsROJdtnioMJROM3Q.png", "Peningkatan Fitur Modern JavaScript di V8" %}_Peningkatan Fitur Modern JavaScript di V8_
...
Terakhir [Ember](https://www.emberjs.com/), yang menghapus [jQuery](https://jquery.com/) dari *boilerplate default-*nya. Meskipun bisa ditambahkan jika perlu. Dengan menghapus jQuery, Ember mampu mengurangi ukurannya sebanyak 20% saja! Selain menghapus jQuery, Ember juga melakukan optimasi di bagian _rendering_-nya.
...
{% image "./assets/images/cds/1_vmHK2v4dEvQKrZG5xyJoww.png", "Contoh mengajari browser menggambar lingkaran di textarea." %}_Contoh mengajari browser menggambar lingkaran di textarea._

Kemudian kita definisikan bagaimana cara membuat lingkaran di `circle.js`.

{% image "./assets/images/cds/1_6wRx6hybqgUlgQ2EoyufvA.png", "Contoh menggambar lingkaran denga JavaScript" %}_Contoh menggambar lingkaran denga JavaScript_

Nah, sekarang kita bisa menggunakan _circle_ tadi di file CSS dengan `paint` API yang sudah tersedia di beberapa browser modern.

{% image "./assets/images/cds/1_8EH9hEb7wYfjuwCrXdndxQ.png", "Memanggil circle di CSS" %}_Memanggil circle di CSS_

{% image "./assets/images/cds/1_Kav2jetOJcCnqXhsAzMAAA.png", "Hasilnya kita bisa menjadikan circle sebagai background dari textarea." %}_Hasilnya kita bisa menjadikan circle sebagai background dari textarea._
...
{% image "./assets/images/cds/1_ldJrzjIXQ5OoJfDz1fbRgw.png", "Bonus: Swaaaagggg!!" %}_Bonus: Swaaaagggg!!_
