...
{% image "./assets/images/f80/1_Mcr11waT9z8dM8rs--G92A.jpeg", "Simon de Haan" %}_Simon de Haan_
...
{% image "./assets/images/f80/1_O2ZOfTZxuRTi-XellkcNdA.jpeg", "Sean Liu" %}_Sean Liu_
...
{% image "./assets/images/f80/1_CNQX-krD7H05uxBOqKsIVg.jpeg", "Edwin (paling kiri)" %}_Edwin (paling kiri)_
...
{% image "./assets/images/f80/1_fNAU2BbDQAgiaRJuTiaMQw.jpeg", "With Bonnie (paling kanan)" %}_With Bonnie (paling kanan)_
...
{% image "./assets/images/f80/1*-g8BP2EG8NCTLWkTM1wNqA.png", "Video Emeka (paling kanan) di stage F8 2018" %}
_Video Emeka (paling kanan) di stage F8 2018. Link: [https://developers.facebook.com/videos/f8-2018/partner-panel-how-to-grow-your-business-with-facebook/](https://developers.facebook.com/videos/f8-2018/partner-panel-how-to-grow-your-business-with-facebook/)_
...
{% image "./assets/images/f80/1_KXoZw7rt24DDmxbH31nZMw.jpeg", "With Kevin" %}_With Kevin_
...
{% image "./assets/images/f80/0_YCHe0_71PsFIPuMn.jpeg", "" %}
...
{% image "./assets/images/f80/1_YBFIr87UYOC-JLDqi6hjoA.jpeg", "Salah satu sisi kantor facebook" %}_Salah satu sisi kantor facebook_
...
{% image "./assets/images/f80/1_J7TJO5VQfndtn3cyjF4flg.jpeg", "Sisi depan" %}_Sisi depan_

Foto diatas tampak depan, sementara dibelakangnya seperti ini.

{% image "./assets/images/f80/1__-iGjoeKE0qUuOjLh0NQqw.jpeg", "Sisa-sisa kejayaan Sun microsytem" %}_Sisa-sisa kejayaan Sun microsytem_
...
{% image "./assets/images/f80/1_KWUEXe6sHoW10TiHhbEnWw.jpeg", "Badge F8" %}_Badge F8_
...
{% image "./assets/images/f80/1_IVtTsYrkvQ4LSoOrVMLL1A.jpeg", "With Andrew Hack Reactor" %}_With Andrew Hack Reactor_
...
{% image "./assets/images/f80/1_8JMsGy6Vn_pi2xCUFiBYtQ.jpeg", "Kevin dibanjiri pertanyaan" %}_Kevin dibanjiri pertanyaan_
...
{% image "./assets/images/f80/0_KkYTQwXh8MSSZnmC.jpg", "Indonesia DevC Leads with Kevin" %}_Indonesia DevC Leads with Kevin_
