...
{% image "./assets/images/f83/1_PkzGAQa0OgRx9Tt1W1Nm2g.jpeg", "Mansion at Alum Rock" %}_Mansion at Alum Rock_
...
{% image "./assets/images/f83/1_wAiRBpcSKLkq63jawhok5w.jpeg", "Tram, kereta lambat." %}_Tram, kereta lambat._
...
{% image "./assets/images/f83/1_qFbcT5Ewp_2-wZbPDD-5OA.png", "Dari Alum Rock(kiri) ke Mountain View" %}_Dari Alum Rock(kiri) ke Mountain View_

Ditengah perjalanan kita sempat melewati kantor Samsung dan ketika ganti tram di stasiun, kita sempatkan berfoto-ria.

{% image "./assets/images/f83/1_ovZjJBDnCK2AITu3jV2S6A.jpeg", "Didepan Kantor Samsung" %}_Didepan Kantor Samsung_
...
{% image "./assets/images/f83/1_N_9HUC5jGKVFB_IgefptoA.jpeg", "Sudut ini mengingatkan saya kepada satu *scene* di film Spiderman." %}

_Sudut ini mengingatkan saya kepada satu scene di film Spiderman._

{% image "./assets/images/f83/1_3mmlzOfdE1E2fpSwntptGA.jpeg", "Downtown Mountain View" %}_Downtown Mountain View_
...
{% image "./assets/images/f83/1_UMWXGXW6fl5F-gRi-F5tyw.jpeg", "Panas cuy!" %}_Panas cuy!_
...
{% image "./assets/images/f83/1_yDLkglfqX6r39PDSQZsnBA.jpeg", "" %}

_Roti makanan pembuka_
...
{% image "./assets/images/f83/1_xIcFgmNDn2qw-Ibp87c47g.jpeg", "" %}
...
{% image "./assets/images/f83/1_UAobZXvO_v1GdJwzhwY7wg.jpeg", "Sulitnya mengendari sepeda sambil selfie." %}_Sulitnya mengendari sepeda sambil selfie._
...
{% image "./assets/images/f83/1_SaqUgSzkQPxem2U-9stgHA.jpeg", "Bersama maskot Android Oreo" %}_Bersama maskot Android Oreo_

{% image "./assets/images/f83/1_o6Jsg-8_AkGXNPXBowUAbQ.jpeg", "Google Merchandise Store" %}

_Google Merchandise Store_

{% image "./assets/images/f83/1_bOZh3QzXEZNNIHmHpwtQGg.jpeg", "Android Lawn Statues" %}_Android Lawn Statues_

{% image "./assets/images/f83/1_5keels7nIe9qqYJsBlgv2w.jpeg", "Kitkat si pencuci mulut, setelah melahap Lamb Pizza" %}
...
{% image "./assets/images/f83/1_KrPupwJzcM43ln3ddAU1UQ.png", "Email dari salah satu karyawan Google" %}_Email dari salah satu karyawan Google_
...
{% image "./assets/images/f83/1_PG5LVLdHpny_wFV5Q96ogw.jpeg", "Adegan golden gate bridge di film x-men." %}_Adegan golden gate bridge di film x-men._

{% image "./assets/images/f83/1_j36Ml1qVMCjvX8uRRpiEfw.jpeg", "Golden Gate saat itu sedang berkabut" %}

_Golden Gate saat itu sedang berkabut_
...
{% image "./assets/images/f83/1_ue18jw-VSjC2hwa0jZTYHA.jpeg", "Didepan kantor GitHub" %}_Didepan kantor GitHub_

Jika ada yang beruntung dapat tur masuk kedalam kantornya, berikut kira-kira [gambaran bagian dalamnya](https://www.officelovin.com/2015/03/20/another-look-inside-githubs-san-francisco-headquarters/).

{% image "./assets/images/f83/1_83k-MVUETA1zPsivcZ21pw.jpeg", "Foto diambil dari officelovin.com" %}_Foto diambil dari officelovin.com_
...
{% image "./assets/images/f83/1_tMLTorv6490bHLlxZ_B4mw.jpeg", "Di Depan Kantor Ubisoft" %}_Di Depan Kantor Ubisoft_
...
{% image "./assets/images/f83/1_v6lFze2pf2Kc1XyHj2UoOQ.jpeg", "Bagian dalam kantor Ubisoft di San Francisco" %}
...
{% image "./assets/images/f83/1_R4fBst5-mC81jIUlSZx-pg.jpeg", "AT&T Park" %}

Kemudian kita melipir dan makan di [Umami Burger](https://www.umamiburger.com/locations/marina-district/). Kali ini makanannya cukup _straightforward_, jadi tidak ada kejadian lucu seperti yang terjadi di Cafe Baklava kemarin. Sambil makan kita juga merencakanan ulang rute perjalanan kita supaya optimal. Karena kita jalan kaki, jadi rute harus super optimal :)

{% image "./assets/images/f83/1_5aG9BY_pTckqipdcPl2avA.jpeg", "Umami Burger di San Francisco" %}

Kemudian petualangan pun dilanjutkan kembali. _First stop_, [Dropbox](https://www.dropbox.com/). Kantor [Dropbox](https://www.dropbox.com/) agak sedikit berbeda karena gedungnya cukup besar dan ada beberapa gedung dalam satu kompleks.

{% image "./assets/images/f83/1_G7KfZqNjp__JwK5tLBiOkw.png", "Foto kompleks perkantoran Dropbox diambil dari Google Maps" %}_Foto kompleks perkantoran Dropbox diambil dari Google Maps_
...
{% image "./assets/images/f83/1_rlW2A7qmoJeBGIlAS2qQJA.jpeg", "Didepan kantor Dropbox" %}

Penasaran dengan tampak dalamnya? Bisa dicek di [tautan berikut](https://www.officelovin.com/2016/12/07/tour-dropboxs-stunning-new-san-francisco-headquarters/).

{% image "./assets/images/f83/1_s2dwh2d_xpiQHdMmZFf1Fg.jpeg", "Foto diambil dari situs officelovin.com" %}_Foto diambil dari situs officelovin.com_
...
{% image "./assets/images/f83/1_KdlhksT3mVsBB_aEDbeBUQ.jpeg", "Foto dari luar kantor Pinterest" %}_Foto dari luar kantor Pinterest_

{% image "./assets/images/f83/1_a9mBHn5HpBQe8hkQVk48Lw.jpeg", "Foto didalam kantor Pinterest. Diambil dari officelovin.com" %}_Foto didalam kantor Pinterest. Diambil dari officelovin.com_

Kemudian kita berjalan lagi menyusuri kawasan _tech company_ di San Francisco dan sampailah kita di kantor [Heroku](https://www.heroku.com/). Agak sepi apa mungkin sudah pindah atau memang sudah jam bubaran kantor?! Masih menjadi misteri.

{% image "./assets/images/f83/1_VS2tcpJHJwL0TjfaVPpn7g.jpeg", "Apakah benar ini kantor Heroku?!" %}_Apakah benar ini kantor Heroku?!_
...
{% image "./assets/images/f83/1_jikJM3nYzLp5GvCPATtFzA.jpeg", "Seperti ini kantor Heroku dari dalam. Foto diambil dari officelovin.com" %}_Seperti ini kantor Heroku dari dalam. Foto diambil dari officelovin.com_

Perjalanan kita lanjutkan hingga secara tidak sengaja bertemu dengan sebuah gedung yang ditutupi logo anjing lucu. Ya, kita ternyata melewati kantor perusahaan game [Zynga](https://www.zynga.com/)! Ternyata itu adalah bagian belakang dari gedung kantornya.

{% image "./assets/images/f83/1_v3iHovK-_cp4An7AeYteRA.jpeg", "Bagian belakang kantor Zynga." %}

_Bagian belakang kantor Zynga._

Dan selang beberapa langkah kita akhirnya sampai di depan kantornya.

{% image "./assets/images/f83/1_jLKpu_GAwBlidPhU7xBNyg.jpeg", "Tampak depan kantor Zynga." %}

_Tampak depan kantor Zynga._
...
{% image "./assets/images/f83/1_Aud-85vcK3M5V2x7ve1eJw.jpeg", "Foto diambil dari officelovin.com" %}
...
{% image "./assets/images/f83/1_6aMBCudXLgtcejaVnBkTqQ.jpeg", "Ngaso di lobby Airbnb" %}_Ngaso di lobby Airbnb_
...
{% image "./assets/images/f83/1_a8wvg8F4g0tsPFvWVsHVGw.jpeg", "Atrium kantor Airbnb. Foto diambil dari officelovin.com" %}
...
{% image "./assets/images/f83/1_0pvn0EyDqKTnQt44eprxAg.jpeg", "Sisi lain San Francisco" %}_Sisi lain San Francisco_
...
{% image "./assets/images/f83/1_QoAYHSkzQi1t9fCvl5-yOg.jpeg", "Alcatraz dari kejauhan" %}_Alcatraz dari kejauhan_

Dan pemandangan terakhir yang bisa kita saksikan adalah singa laut yang sedang berjemur jika musim panas tiba.

{% image "./assets/images/f83/1_qkJn9ntAhWmbAlqqL95SIw.jpeg", "Singa laut sedang berjemur." %}
